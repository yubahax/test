...
import com.example.yubatest.Interceptor.SaTokenInterceptor;
...
//                .addExclude("/*")
                ...
                .setAuth(obj -> {
                    ...
                    SaManager.getLog().debug("请求时间={} 请求path={} 提交token={}", currentDateTime, SaHolder.getRequest().getRequestPath(), StpUtil.getTokenValue());
                    // ...
                })
